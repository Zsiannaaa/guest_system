 ...
 * Purpose: Login page/controller that validates credentials, creates the user session, and sends users to their role dashboard.
 ...
 * Security: Uses password verification and session creation helpers so credentials are not handled directly in the view.
 */
// ============================================================
