 ...
 * Purpose: Guest House page/controller for checkin. It connects forms and views to Guest House booking/room modules.
...
// Study query: SQL query: reads rows from guest_house_bookings, guests, guest_house_rooms, gh_room_types for lookup, validation, or display.
$queue = $db->query("
