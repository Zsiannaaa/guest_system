...
$pageTitle = 'Currently Serving'; $db = getDB();
...
<div class="page-top">
  <div><div class="page-title">Currently Serving</div>
  <ul class="breadcrumb"><li><a href="<?= getDashboardUrl() ?>">Dashboard</a></li><li>Currently Serving</li></ul></div>
</div>

<div class="card">
  <div class="card-header" style="background:#f0fdf4;"><span style="display:flex;align-items:center;gap:8px;"><span class="live-dot"></span><strong><?= $total ?></strong> guest<?= $total!==1?'s':'' ?> being served</span></div>
  <div class="table-responsive">
    <table class="data-table">
      <thead><tr><th>Guest</th><th>Reference</th><th>Purpose</th><th>Arrived</th><th>Status</th><th>Actions</th></tr></thead>
      <tbody>
      <?php if (empty($guests)): ?><tr><td colspan="6"><div class="table-empty">No guests currently being served.</div></td></tr>
